  ...
  return (
    <div className="bg-white shadow-lg">
      ...
      <div className="p-3">
        ...
        <a
          href=""
          className="block text-center font-semibold mt-3 w-full py-2 bg-text-header text-white hover:bg-white hover:text-text-header border border-text-header duration-150 ease-in-out"
        >
          Selengkapnya
        </a>
      </div>
